      ...
      items: [
        {
          ...
          buyLink: "https://toteme-studio.com/search?type=product&q=ivory+blazer",
        },
        {
          ...
          buyLink: "https://www.theory.com/search?q=wide+leg+trouser+black",
        },
        {
        ...
        },
        {
          ...
          brand:   "Net-a-Porter",
          price:   "$200–$600",
          note:    "The block heel pointed pump — polished enough for the boardroom, comfortable enough for a full day. Every result is a quality brand.",
          buyLink: "https://www.net-a-porter.com/en-us/shop/search?q=black+block+heel+pump",
        },
        {
          ...
          buyLink: "https://www.toryburch.com/en-us/search?q=Lee+Radziwill+tote",
        },
      ],
    },
      ...
      items: [
        {
          ...
          buyLink: "https://www.thereformation.com/search?q=cleo+linen+pant",
        },
        {
        ...
        },
        {
          ...
          buyLink: "https://mejuri.com/search?q=bold+hoops+gold",
        },
        {
    ...
    /* ── THE WILDCARD ──────────────────────────────────────── */
    {
      ...
      items: [
        ...
        },
        {
          ...
          buyLink: "https://www.everlane.com/search?q=cropped+denim+jacket",
        },
        {
          piece:   "Strappy flat sandal in tan",
          brand:   "Net-a-Porter",
          price:   "$150–$500",
          note:    "Understated, goes with everything, doesn't compete with the dress. Every result is a quality brand.",
          buyLink: "https://www.net-a-porter.com/en-us/shop/search?q=strappy+flat+sandal+tan",
        },
        {
          ...
          buyLink: "https://mejuri.com/search?q=fine+gold+chain+necklace",
        },
        {
          piece:   "Mini crossbody bag in black",
          brand:   "Net-a-Porter",
          price:   "$200–$800",
          note:    "Small enough to be intentional, structured enough to look considered. Only luxury brands.",
          buyLink: "https://www.net-a-porter.com/en-us/shop/search?q=mini+crossbody+bag+black",
        },
      ],
    },
  ],
