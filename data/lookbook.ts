      ...
      items: [
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=toteme+double+breasted+blazer+ivory",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=theory+wide+leg+trousers+black+crepe",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=vince+silk+camisole+cream",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=sam+edelman+block+heel+pointed+pump+black",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=tory+burch+leather+tote+cognac",
        },
      ],
    },
      ...
      items: [
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=reformation+linen+wide+leg+trousers+ecru",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=everlane+fitted+white+crew+tee",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=mejuri+gold+hoop+earrings",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=adidas+stan+smith+white+leather+sneaker",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=baggu+canvas+tote+natural",
        },
      ],
    },
      ...
      items: [
        {
          ...
          brand:   "Sézane",
          price:   "$195",
          note:    "Sézane's Léa dress. The cut does everything — no styling required beyond the earring.",
          buyLink: "https://www.nordstrom.com/sr?keyword=sezane+bias+cut+slip+dress+champagne",
        },
        {
          piece:   "Classic denim jacket",
          brand:   "Madewell",
          price:   "$148",
          note:    "The Jean Jacket. Throw it on the slip and you've turned evening into afternoon.",
          buyLink: "https://www.nordstrom.com/sr?keyword=madewell+classic+denim+jacket",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=sam+edelman+strappy+flat+sandal+tan",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=mejuri+delicate+gold+chain+necklace",
        },
        {
          ...
          buyLink: "https://www.nordstrom.com/sr?keyword=mini+crossbody+bag+black+structured",
        },
      ],
    },
  ],
